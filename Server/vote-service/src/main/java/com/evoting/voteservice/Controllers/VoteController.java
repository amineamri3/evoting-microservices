...
public class VoteController {
    ...
    @ResponseBody
    public ResponseEntity<Response> getAllVotesByCandidat(@RequestParam(required = false) String nomElection){
        Map<String, Map<String, Long>> data = new HashMap<String, Map<String, Long>>() {
            {
                put("Stats", iVote.retrieveAllVotesByCandidat(nomElection));
            }
        };
        return ResponseEntity.ok(
                Response.builder()
