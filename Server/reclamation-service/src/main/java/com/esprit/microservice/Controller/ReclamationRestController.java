...
public class ReclamationRestController {
	...
	// http://localhost:8035/reclamations/1
		 ...
		 // http://localhost:8035/reclamation/add
		...
		// http://localhost:8081/SpringMVC/reclamation/delete/{reclamation-id}
		 ...
		 // http://localhost:8035/reclamation/modify
		 @PutMapping("/modify")
		 @ResponseBody
		...
		// http://localhost:8035/reclamation/retrieve-by-titre/satisfait
		 ...
		 // http://localhost:8035/reclamation/retrieve-reclamations-asc
		...
		// http://localhost:8035/reclamation/retrieve-reclamations-desc
